...
class stock_picking(osv.osv):
    ...
    _columns = {
        'ship_method': fields.related('sale_id', 'ship_method', string='Shipping Method', type='char', size=128,
...
class stock_move(osv.osv):
    ...
    _columns = {
        'ship_method': fields.related('picking_id', 'sale_id', 'ship_method', string='Shipping Method', type='char', size=128,
            store = {'sale.order': (_get_sale_order, ['ship_method'], -10)})
        }
