            ...
            #                                   //if success is True
                ...
                if cust_profile_Id and numberstring:
                    ...
                    if dict_wallet.get('fill_amount')>0.0:
                        amount=dict_wallet.get('fill_amount')
			print "userauthobj------------------------",user_auth_obj
                        present_amt_playjam_req=user_auth_obj.wallet_playjam(active_id, 0.0, context=None)
    ...
    #                                return json.dumps(result) 
			    print"resultttttttttttttttttttttttttttttttttttttttttttttttttttT"
                            ...
                            if response.get('resultCode') == 'Ok':
                                wallet_response=user_auth_obj.wallet_playjam(active_id, amount, context=None)
