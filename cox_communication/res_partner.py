...
#                    print "auth_respauth_respauth_resp",auth_resp
                    if auth_resp:
                        ...
                        if auth_email_id=='E00039':
                            raise osv.except_osv(_('Warning !'),_('Email Already Exists.at Authorize end.Enter different emailid.')) 
                        else:
    ...
    #    kjlkjlkj
		...
		print "if condition satisfieed for no saerch paymnt profile........"
	    ...
	    print "active _payment pprlkjfkrevkjhvkjhvjb",active_payment_profile_id
