    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        if view_type == 'form':
            ...
            if active_id:
                ...
                if (obj_brw.auth_transaction_id) and obj_brw.auth_respmsg=='This transaction has been approved.':
...
class charge_customer(osv.osv_memory):
    ...
    def charge_customer(self,cr,uid,ids,context={}):
        ...
        next_retry = today + relativedelta(weeks=1)
...
#                        payment_exception_id = context.get('payment_exception_id',False)
                        if payment_exception_id and message:
                            ...
                            payment_obj.write(cr,uid,[payment_exception_id],{'message':message,'next_retry_date':next_retry})
