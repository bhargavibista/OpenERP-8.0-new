...
#	print"context",context
    ...
    def refund_service(self,cr,uid,ids,context={}):
        ...
        for invoice in invoice_lines:
            ...
            cr.execute("select number,customer_profile_id,customer_payment_profile_id,auth_transaction_id,cc_number from account_invoice where id=%s"%(int(invoice)))
...
#                context['linked_refund'] = True
                ...
                cust_payment_profile_id=payment_profile_data.get('customer_payment_profile_id','')
                auth_transaction_id=payment_profile_data.get('auth_transaction_id','')
                cc_number=payment_profile_data.get('cc_number','')
                cust_profile_id=payment_profile_data.get('customer_profile_id','')
