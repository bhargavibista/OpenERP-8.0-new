...
#    _rec_name = "product_id"
    ...
    _columns = {
        ...
        'product_name': fields.related('product_id', 'name', type='char', string='Name',store=True),# new field to show product name instead of product id because it in web client it shows product id
