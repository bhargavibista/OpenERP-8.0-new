...
#        line['so_line_item_set_ids'] = [(6,0, [x.id for x in procurement.so_line_item_set_ids])] cox gen2
...
#        'so_line_item_set_ids': fields.related('sale_order_line_id', 'so_line_item_set_ids', type='many2many', relation='sale.order.line.item.set', string='Choosen configuration'), cox gen2
    }
