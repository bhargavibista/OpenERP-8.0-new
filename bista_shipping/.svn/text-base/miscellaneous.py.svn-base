...
class Address(object):
    def __init__(self, name, address, city, state_code, zip, country_code, address2='', phone='', email='', company_name='', country='', is_residence=True):
        ...
        self.zip = str(zip)[:7] if zip else ''
